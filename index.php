<?php 
    $faqs = [
       ...
       [
        ...
        Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel Centro Google per la sicurezza online1.
...
<body>
    ...
    <div class="container">
        ...
        <div class="lower-header flex">
            ...
            <div class="menu"><a href="#">Norme sulla privacy</a></div>
            <div class="menu"><a href="#">Termini di servizio</a></div>
            <div class="menu"><a href="#">Tecnologie</a></div>
            <div class="menu"><a href="#">Domande frequenti</a></div>
        </div>
    </div>
    </header>
    ...
    <main>
        <div class="second-container"> 
            ...
            <?php foreach($faqs as $faq){ ?>
                <div>
                    <div class="question bold"><?echo $faq[question]; ?></div>
                    <div class="answer"><? echo $faq[answer]; ?></div>
                </div>
             <?php } ?>
